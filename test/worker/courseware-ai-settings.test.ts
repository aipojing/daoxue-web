        ...
        api(
          `/api/admin/ai-catalog/endpoints/${endpoint.id}`,
          {
            ...
            body: JSON.stringify({
              ...
              baseUrl: 'https://race.example/api/v1/services/audio/tts/SpeechSynthesizer',
              config: { mediaHostSuffixes: ['media.example'] },
              enabled: true,
            }),
          },
          admin.cookie,
        ...
        api(
          `/api/admin/ai-catalog/endpoints/${targetEndpoint.id}`,
          {
            ...
            body: JSON.stringify({
              ...
              capability: 'speech_synthesis',
              adapterType: 'token_plan_tts',
              baseUrl: 'https://target.example/api/v1/services/audio/tts/SpeechSynthesizer',
              config: { mediaHostSuffixes: ['media.example'] },
              enabled: true,
            }),
          },
      ...
      const response = await api(
        `/api/admin/ai-catalog/endpoints/${deepseek.endpoint_id}`,
        {
          ...
          body: JSON.stringify({
            ...
            capability: 'speech_synthesis',
            adapterType: 'token_plan_tts',
            baseUrl: 'https://safe.example/api/v1/services/audio/tts/SpeechSynthesizer',
            config: { mediaHostSuffixes: ['media.example'] },
            enabled: true,
          }),
        },
